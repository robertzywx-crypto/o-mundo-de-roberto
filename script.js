%%javascript
// RPG "O MUNDO DE ROBERTO" - CÓDIGO JAVASCRIPT PURO
// Este código foi extraído do HTML e deve ser carregado APÓS o carregamento do DOM (Document Object Model).
...
// -----------------------------
// Variáveis de Referência (Declaradas fora da função de inicialização)
// -----------------------------
let out, btnAtk, btnMag, btnDef, btnFugir, btnMapa, mapaDiv;


// -----------------------------
// Função Principal: Inicia o Jogo após o carregamento do DOM
// -----------------------------
function iniciarJogo() {
    // -----------------------------
    // Referências HTML (Só são seguras após o carregamento do DOM)
    // -----------------------------
...
// -----------------------------
// Esta linha garante que a função 'iniciarJogo' só rode após o HTML estar pronto.

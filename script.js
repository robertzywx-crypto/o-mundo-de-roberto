...
const cidades = {
    Frostvale: {
        ...
        historiaPosChefe: "❄️ Frostvale está livre novamente."
    },
    Oakheart: {
        historia: "Oakheart – A Cidade das Florestas.",
        monstros: [
            { nome: "Goblin Verde", vida: 75 },
            { nome: "Ent da Floresta", vida: 150 }
        ],
        chefe: { nome: "Guardião Ancestral", vida: 300 },
        historiaPosChefe: "🌳 Oakheart floresce outra vez."
    },
    Emberforge: {
        historia: "Emberforge – A Cidade do Fogo.",
        monstros: [
            { nome: "Salamandra de Fogo", vida: 105 },
            { nome: "Basilisco Flamejante", vida: 165 }
        ],
        chefe: { nome: "Titã de Magma", vida: 400 },
        historiaPosChefe: "🔥 Emberforge foi libertada."
    },
    Stormreach: {
        historia: "Stormreach – Cidade das Tempestades.",
        monstros: [
            { nome: "Elemental de Trovão", vida: 120 },
            { nome: "Raio Errante", vida: 180 }
        ],
        chefe: { nome: "Dragão Elétrico", vida: 360 },
        historiaPosChefe: "⚡ Stormreach está em paz."
    },
    Shadowfen: {
        historia: "Shadowfen – O covil final.",
        monstros: [
            { nome: "Sapo Gigante", vida: 90 },
            { nome: "Serpente Sombria", vida: 150 }
        ],
        chefe: { nome: "Lorde das Trevas", vida: 5000 },
        historiaPosChefe: "👑 O mundo foi salvo!"
    },
    Aethelburg: {
        historia: "Aethelburg – A Capital, lar da Grande Biblioteca.",
        monstros: [],
        chefe: null,
...
function mostraStatus() {
    log(`👤 ${player.nome} | LVL ${player.nivel} | ❤️ ${player.vida}/${player.maxVida} | 🔮 ${player.mana}/${player.maxMana}`);
}
...
function iniciarCombate(monstro) {
    ...
    limpar();
    log(`⚔️ ${inimigoAtual.nome} apareceu! (${inimigoAtual.vida} HP)`);
    mostraStatus();
}
...
function visitarCidade(nome) {
    ...
    if (nome === "Aethelburg") {
        log("📜 O velho bibliotecário diz: nem todo livro aqui quer ser lido... Alguns preferem observar.");
        return;
    }
